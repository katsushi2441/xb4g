...
$FAQ = [
  ['株式会社エクスブリッジはどんな会社ですか？', '愛知県名古屋市のAIシステム開発会社です。中国オフショア開発から創業し、基幹業務パッケージを開発するITベンダー、ネット通販事業を経て、現在は第4世代としてAI事業を行っています。AIプロダクトの開発・提供、バイブコーディングによる受託開発、SaaSからオープンソースへの置き換え支援が主な事業です。第4世代のテーマとして、政治・社会の課題に対応する情報技術をAIを活用して提供していくことを掲げています。'],
  ...
  ['第4世代とはどういう意味ですか？', 'エクスブリッジの事業の変遷を4つの世代で表しています。第1世代は中国オフショア開発、第2世代は基幹業務パッケージを自社開発するITベンダー、第3世代はネット通販、そして第4世代が現在のAI事業です。第4世代のテーマは、政治・社会の課題に対応する情報技術を、AIを活用して提供していくことです。'],
];

$title = 'エクスブリッジ 第4世代 | AIプロダクトとオープンソースのポータル';
$desc  = '株式会社エクスブリッジ（名古屋）が運営する全サイトのポータル。第4世代のテーマは、政治・社会の課題に対応する情報技術をAIを活用して提供すること。Kurageの解説動画、AI・OSSの技術記事、SaaS→OSS対応表、業種別ITソリューション、買い切りの業務システムまでを1ページから。';
?><!DOCTYPE html>
<html lang="ja">
<head>
<meta charset="UTF-8">
...
<script type="application/ld+json"><?= json_encode([
  ...
  '@graph' => [
    ['@type' => 'Organization', '@id' => 'https://exbridge.jp/#org',
     ...
     'description' => '名古屋のAIシステム開発会社。中国オフショア開発、基幹パッケージのITベンダー、ネット通販を経て、第4世代としてAI事業を行う。政治・社会の課題に対応する情報技術を、AIを活用して提供している。',
